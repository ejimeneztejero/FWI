!call solver_forward_simple(nr,nxs,nys,nxr(:),nyr(:),&
!delta,dmodel,dt,ny,nx,model,nt,Gs) 

subroutine solver_forward_simple(NumRec,nxSou,nySou,nxRec,nyRec,&
S,d,dt,ny,nx,ctmp,nt,Rec_point)

implicit none

	!!!! Simulation Geometry
	integer :: rank,iprop,i,nt,ny,nx,j,k
	integer :: icont,nn,dn
...
end subroutine solver_forward_simple
